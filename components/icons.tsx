...
export const BetterGPTIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <g>
        <path
          d="M17.45 55h22.72c.76 0 1.44-.29 1.97-.76.53.47 1.21.76 1.97.76h.85a2.97 2.97 0 0 0 2.97-2.83c.09-1.97.32-5.28.89-9.81.83-6.63-.44-15.46-.84-17.99 4.16-2.66 4.38-7.26 4.39-7.46.01-.15-.02-.3-.08-.44-1.6-3.64-4.54-5.57-5.79-6.26-.21-3.27-2.65-4.96-2.76-5.04a.991.991 0 0 0-1.19.05c-1.39 1.11-2.21 2.49-2.7 3.78-.98-1.57-2.16-2.64-2.24-2.71-.2-.18-.46-.27-.73-.25s-.51.14-.69.34c-4.52 5.16-4.17 14.46-3.98 16.97-2.29 1.56-10.74 8.39-11.1 23.9h-3.54c-1.41 0-2.58-1.09-2.6-2.42-.01-.73.23-1.56.72-2.46.87-1.6.28-3.65-1.32-4.56-1.5-.86-3.4-.47-4.43.91-.86 1.15-1.95 3.04-2.25 5.5-.3 2.52.67 5.4 2.55 7.51 1.88 2.11 4.44 3.27 7.21 3.27zM9.68 44.46c.24-2.02 1.15-3.59 1.86-4.54a1.4 1.4 0 0 1 1.83-.37c.65.37.9 1.23.56 1.87-.65 1.21-.98 2.36-.96 3.44.04 2.42 2.11 4.39 4.6 4.39h4.53c.55 0 1-.45 1-1 0-17.1 10.55-23.46 10.66-23.52.34-.2.54-.58.49-.98-.01-.1-1.01-9.76 2.77-15.2.88 1 2.02 2.64 2.11 4.24.03.54.49.99 1.04.94a1 1 0 0 0 .96-1.02c0-.03-.04-3.17 2.03-5.36.57.62 1.36 1.77 1.32 3.46-.01.41.23.78.6.94.04.02 3.51 1.58 5.25 5.3-.09.88-.66 4.16-3.94 5.93a1 1 0 0 0-.51 1.05c.02.11 1.86 10.73.94 18.08-.58 4.6-.81 7.96-.9 9.97-.02.52-.44.92-.96.92h-.85a.97.97 0 0 1-.97-.97V42.32c0-.55-.45-1-1-1s-1 .45-1 1V52.03c0 .54-.44.97-.97.97h-.74a.98.98 0 0 1-.97-.91c-.2-3.11-.92-4.67-1.61-6.18-.88-1.91-1.78-3.89-1.78-9.63 0-.55-.45-1-1-1s-1 .45-1 1c0 6.18 1.04 8.45 1.96 10.46.67 1.47 1.26 2.74 1.43 5.48.02.27.08.53.17.78H17.45c-2.19 0-4.22-.92-5.71-2.6-1.5-1.7-2.29-3.98-2.06-5.94z"
        />
        <path
          d="M43.94 16.24c.13 0 .26-.03.38-.08s.23-.12.33-.22c.18-.18.29-.44.29-.7 0-.13-.03-.26-.08-.39a.988.988 0 0 0-.21-.32c-.1-.09-.21-.17-.33-.22a1.02 1.02 0 0 0-1.09.22.99.99 0 0 0-.29.71c0 .26.1.52.29.7a1 1 0 0 0 .71.3z"
        />
      </g>
    </svg>
  );
...
export const LogoSpotify = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
    ...
    >
      <path
        d="M8 0C3.589 0 0 3.589 0 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm3.67 11.548a.499.499 0 01-.686.165c-1.879-1.147-4.243-1.407-7.028-.77a.5.5 0 01-.222-.975c3.048-.696 5.662-.397 7.77.896a.5.5 0 01.166.684zm.979-2.178a.624.624 0 01-.858.205c-2.15-1.321-5.428-1.704-7.972-.932a.625.625 0 01-.362-1.194c2.905-.881 6.517-.454 8.986 1.063a.624.624 0 01.206.858zm.084-2.268c-2.578-1.531-6.832-1.672-9.294-.925a.75.75 0 11-.374-1.45c2.826-.727 7.523-.581 10.492 1.192a.75.75 0 11-.824 1.183z"
        fill="#1DB954"
      />
    </svg>
  );
